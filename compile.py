...
header_dict = {
    "aeorosol_optics": "serdeae.h",
    "surface_spectral": None,
    "cloud_optics": "serdeco.h",
...
sdfg = dace.SDFG.from_file("sdfgs/calc_surface_spectral_simplified_dbg22.sdfgz")
sdfg = dace.SDFG.from_file("sdfgs/cloud_optics_fn_438_simplified_dbg22.sdfgz")
...
sdfg = dace.SDFG.from_file("sdfgs/get_albedos_simplified_dbg22.sdfgz")
sdfg = dace.SDFG.from_file("sdfgs/solver_mcica_lw_simplified_dbg22.sdfgz")
sdfg = dace.SDFG.from_file("sdfgs/solver_mcica_sw_simplified_dbg22.sdfgz")
